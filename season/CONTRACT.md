...
```
{
 ...
 decision_history:[{week:number,generated_at:ISO,current_week:boolean,decisions:[{id:string,title:string,recommendation:string,status:string,flip_condition:string}]}],
